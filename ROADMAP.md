...
- [ ] Remover aliases e variáveis globais gradualmente (catálogos, uploads, persistência, exportações e editor de Flows isolados; adaptadores temporários permanecem enquanto o coordenador legado é reduzido).
