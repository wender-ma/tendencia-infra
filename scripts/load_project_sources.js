...
function loadProjectSources() {
  ...
  const javascript = [
    ...
    readProjectFile('assets/js/services/dashboard-dataset-repository.mjs'),
    readProjectFile('assets/js/services/project-repository.mjs'),
    readProjectFile('assets/js/services/storage-service.mjs'),
    ...
    readProjectFile('assets/js/ui/formatters.mjs'),
    readProjectFile('assets/js/ui/table-interactions.mjs'),
    ...
    readProjectFile('assets/js/ui/project-controller.mjs'),
