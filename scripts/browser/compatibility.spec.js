...
test('impressão da aba ativa e exportação XLSX funcionam', async ({ page }, testInfo) => {
  ...
  const printLayout = await page.evaluate(() => ({
    ...
    hiddenDisplays: [...document.querySelectorAll('.tab-content:not(.active)')].map(
  ...
  await page.evaluate(() => window.dashboardServices.actions.resolve('exportarDetalhamentoXLSX')());
