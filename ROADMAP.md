...
- [ ] Separar cada aba em um módulo de visualização (Detalhamento, Flows, Tendência de Obra, Uploads, Histórico e Controle de Projeção concluídos; demais abas pendentes).
