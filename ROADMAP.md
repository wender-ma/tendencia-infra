...
- [ ] Remover aliases e variáveis globais gradualmente (catálogos, uploads, persistência, exportações, shell e editor de Flows isolados; adaptadores temporários permanecem enquanto o coordenador legado é reduzido).
