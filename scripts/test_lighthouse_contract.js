...
assert(
  runner.includes("skipAudits: ['is-crawlable']"),
  'Exceção temporária de indexabilidade não documentada no runner',
);
...
console.log('Contrato Lighthouse: orçamentos, noindex deliberado e artefato de CI OK');
