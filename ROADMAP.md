...
- [ ] Separar tabelas em módulos de UI (Detalhamento, Flows, Histórico, uploads e movimentações da projeção concluídos; demais tabelas pendentes).
- [ ] Separar cada aba em um módulo de visualização (Detalhamento, Flows, Uploads, Histórico e Controle de Projeção concluídos; demais abas pendentes).
