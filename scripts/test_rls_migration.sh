...
run_sql "Aplicando reflexo IPCA/INCC e anotacoes" "supabase/migrations/20260804123000_flow_reflection_inflation.sql"
run_sql_expect_complete "Auditando contrato publico simplificado" "supabase/audit/verify_release_hardening_deployment.sql"
run_sql_expect_complete "Auditando reflexo IPCA/INCC e anotacoes" "supabase/audit/verify_flow_reflection_inflation_deployment.sql"
run_sql "Validando reflexo IPCA/INCC e anotacoes" "supabase/tests/assert_flow_reflection_inflation.sql"
run_sql "Aplicando rollback do reflexo IPCA/INCC" "supabase/rollback/20260804123000_flow_reflection_inflation_rollback.sql"
run_sql "Validando rollback do reflexo IPCA/INCC" "supabase/tests/assert_flow_reflection_inflation_rollback.sql"
