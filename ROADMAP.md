...
- [ ] Remover aliases e adaptadores globais gradualmente até os módulos consumirem serviços e estado por importação ou injeção direta (runtime e utilitários usam injeção; handlers das views dinâmicas já usam registro explícito de ações).
