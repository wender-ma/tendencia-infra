...
assert(!inlineEventPattern.test(javascript), 'Templates JavaScript contêm handler de evento inline');
...
assert(actions.includes("element.tagName === 'FORM'"), 'Submit de formulário não previne navegação');
